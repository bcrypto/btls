...
{\bf\large ПРОТОКОЛ ЗАЩИТЫ ТРАНСПОРТНОГО УРОВНЯ\\ ВЕРСИИ 1.3}\\

\vskip2cm
\noindent
{\bf\Large Iнфармацыйныя тэхналогii i бяспека}\\[10pt]
{\bf\large ПРАТАКОЛ АХОВЫ ТРАНСПАРТНАГА ЎЗРОЎНЮ\\ ВЕРСII 1.3}\\ 

\vskip2cm
\noindent
{\bf (RFC 8446:2018, NEQ)}\\ 
...
УДК~$\phantom{004.056.5.057.4}$\hfill
ОГКС~35.240.01\hfill
NEQ
...
3~Настоящий стандарт разработан с учетом основных нормативных положений 
документа RFC 8446:2018 <<The Transport Layer Security (TLS) Protocol. Version 
1.3>> (<<Протокол защиты транспортного уровня. Версия 1.3>>)
