...
расширение \token{supported_versions}.
%
...
Сервер может указать в \token{cookie} хэш-значение первого сообщения
...
хэш-значением, указанным в \token{cookie}. При такой схеме взаимодействия 
